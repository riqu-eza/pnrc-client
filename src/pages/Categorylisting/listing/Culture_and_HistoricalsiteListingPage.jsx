...
import Culture_and_Historicalsitesmenu from "../menu/Culture_and_Historicalsites";

const Culture_and_HistoricalsitesListingPage = () => {
  const { state } = useLocation();

  // Add a fallback to avoid destructuring undefined 'state' or 'listing'
  const listing = state?.listing || {};
  console.log("Culture_and_Historicalsites", listing);
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="mb-6 p-1">
            <div className="border bg-gray-100 shadow-lg">
              <Culture_and_Historicalsitesmenu
...
export default Culture_and_HistoricalsitesListingPage;
