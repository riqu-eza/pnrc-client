...
const EntertainmentForm = ({ setEntertainmentItems, Subcategory }) => {
  // Configuration object: fields required for each subcategory
  ...
  const subcategoryFields = {
    "Cinema & Theaters": [
      ...
      { name: "genre", type: "text", placeholder: "Movie Genre" },
      { name: "rating", type: "text", placeholder: "Rating" },
      { name: "time", type: "time", placeholder: "Show Time" },
    ...
    "Music & Live Performances": [
      { name: "name", type: "text", placeholder: "Performance Name" },
      { name: "artist", type: "text", placeholder: "Artist/Band" },
      { name: "time", type: "time", placeholder: "Performance Time" },
      { name: "price", type: "number", placeholder: "Ticket Price" },
      { name: "venue", type: "text", placeholder: "Venue" },
    ],
    Nightlife: [
      { name: "name", type: "text", placeholder: "Event Name" },
      { name: "price", type: "number", placeholder: "Entry Fee" },
      { name: "time", type: "time", placeholder: "Start Time" },
      { name: "venue", type: "text", placeholder: "Venue" },
    ],
    "Gaming & Indoor Fun": [
      { name: "name", type: "text", placeholder: "Game/Event Name" },
      { name: "price", type: "number", placeholder: "Price" },
      { name: "time", type: "time", placeholder: "Booking Time" },
      { name: "venue", type: "text", placeholder: "Location" },
    ],
    "Amusement & Recreation": [
      { name: "name", type: "text", placeholder: "Activity Name" },
      { name: "price", type: "number", placeholder: "Entry Fee" },
      { name: "time", type: "time", placeholder: "Opening Time" },
      { name: "venue", type: "text", placeholder: "Venue" },
    ],
    "Sports & Outdoor Activities": [
      { name: "name", type: "text", placeholder: "Sport/Activity Name" },
      { name: "price", type: "number", placeholder: "Participation Fee" },
      { name: "time", type: "time", placeholder: "Start Time" },
      { name: "venue", type: "text", placeholder: "Location" },
    ],
  };
  ...
  const handleAddMenuItem = () => {
    ...
    setEntertainmentItems((prev) => [...prev, newEntry]);
