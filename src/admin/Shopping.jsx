  ...
  const subcategoryFields = {
    "Shopping Malls": [
      ...
      },
      {
        name: "foodCourt",
        type: "boolean",
        placeholder: "Food Court Available?",
      },
      {
        name: "entertainmentOptions",
        type: "text",
        placeholder: "Entertainment Options",
      },
      {
        name: "securityServices",
        type: "boolean",
        placeholder: "Security Services Available?",
      },
      {
        name: "facilities",
        type: "text",
    ...
    Boutiques: [
      {
        name: "specialization",
        type: "text",
        placeholder: "Specialization (e.g., fashion, accessories)",
      },
    ],
    Markets: [
      {
        name: "marketType",
        type: "text",
        placeholder: "Type (e.g., farmers, flea)",
      },
      { name: "operatingDays", type: "text", placeholder: "Operating Days" },
      {
        name: "entranceFee",
        type: "number",
        placeholder: "Entrance Fee (if any)",
      },
    ],
    "Antique Stores": [
    ...
    "Souvenir Shops": [
      {
        name: "itemsAvailable",
        type: "text",
        placeholder: "Types of Souvenirs",
      },
    ...
    "Speciality Stores": [
      { name: "speciality", type: "text", placeholder: "Speciality Items" },
      {
        name: "uniqueServices",
        type: "text",
        placeholder: "Unique Services Offered",
      },
    ],
  };
